...
class InternalStorage @Inject constructor(private val context: Context) : LocalDataSource {
    ...
    override suspend fun getAllContactsFromDevice(): Flow<Result<List<Contact>>> =
        ResultUtils.requestFlow {
            ...
            val selectionArgs = arrayOf("com.android.contacts.default")
            ...
            if (cursor != null && cursor.moveToFirst()) {
                do {
                    ...
                    val photo = cursor.getString(cursor.getColumnIndexOrThrow(projection[3]))
